...
const Config: any = _.pick(process.env, [
  ...
  // 国内短信
  'ALI_API_KEY', 'ALI_API_SECRET', 'ALI_SMS_TEMPLATE', 'ALI_SMS_SIGN', 'ALI_SMS_TEMPLATE_PARAM',
  // 国际/港澳台短信
  'ALI_API_KEY2', 'ALI_API_SECRET2', 'ALI_SMS_TEMPLATE2', 'ALI_SMS_SIGN2', 'ALI_SMS_TEMPLATE_PARAM2',
  // 国内短信
  'TENCENT_SMS_APP_ID', 'TENCENT_SECRET_ID', 'TENCENT_SECRET_KEY', 'TENCENT_SMS_TEMPLATE', 'TENCENT_SMS_SIGN', 'TENCENT_SMS_TEMPLATE_PARAM_SET',
  // 国际/港澳台短信
  'TENCENT_SMS_APP_ID2', 'TENCENT_SECRET_ID2', 'TENCENT_SECRET_KEY2', 'TENCENT_SMS_TEMPLATE2', 'TENCENT_SMS_SIGN2', 'TENCENT_SMS_TEMPLATE_PARAM_SET2',
